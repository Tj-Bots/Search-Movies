...
- [x] חיפוש קבצים/וידאו ממאגרים שתגדיר.
- [x] הוספת קבצים מערוץ בפקודה אחת.
- [x] חיוב הרשמה לערוץ עדכונים.
- [x] חסימת משתמשים/קבוצות עם פקודה קלה למנהל.
- [x] שידור הודעה למשתמשים, עם/בלי תג הועבר.
- [x] ערוץ לוג שמתריע על כל משתמש/קבוצה חדש/ה בבוט.
- [x] הורדת סרטונים מטיקטוק, ועוד הרבה דברים מגניבים.
- [ ] מידע על קבצים (mediainfo) בקרוב!
