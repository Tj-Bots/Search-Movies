...
# ***⌨️ פקודות למנהלים***
```
admin - פאנל ניהול מלא (שידור, חסימות, משתמשים, הגדרות מערכת, מילים חסומות, חיפושים פופולריים, מד עומס שרת, סטטיסטיקות). [Admin only]
...
| `FREE_DAILY_SEARCHES` | ❌ | כמות קבצים חינמיים ליום (מתאפס בחצות שעון ישראל). ברירת מחדל: 5 |
